...
import { Check, Ellipsis, Folder, History, Menu, PanelLeft, ScrollText, Server, SquareTerminal, Wand2, Zap } from "lucide-react";
      ...
      <CommandPalette
        ...
        onNewSession={() => {
          ...
          void hostFetch("/api/default-cwd", { method: "POST" })
            ...
            .then((cwd) => handleNewSession(`palette-${Date.now()}`, cwd))
